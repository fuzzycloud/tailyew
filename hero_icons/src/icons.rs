...
pub fn arrow_circle_left(props: &IconProps) -> Html {
...
pub fn arrow_circle_right(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
...
pub fn arrow_down(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
                 <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ArrowNarrowLeft)]
pub fn arrow_narrow_left(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
               <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ArrowNarrowRight)]
pub fn arrow_narrow_right(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
               <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn arrow_right(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ArrowSmDown)]
pub fn arrow_sm_down(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ArrowSmLeft)]
pub fn arrow_sm_left(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ArrowSmRight)]
pub fn arrow_sm_right(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ArrowSmUp)]
pub fn arrow_sm_up(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ArrowsExpand)]
pub fn arrows_expand(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
                   <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(AtSymbol)]
pub fn at_symbol(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn backspace(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(BadgeCheck)]
pub fn badge_check(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(Ban)]
pub fn ban(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
               <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn beaker(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn book_open(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(BookmarkAlt)]
pub fn bookmark_alt(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
             <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn bookmark(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
             <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(AcademicCap)]
pub fn academic_cap(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
                   <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn annotation(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
                   <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn archive(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
                   <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn arrow_circle_up(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
                   <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn presentation_chart_bar(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(PresentationChartLine)]
pub fn presentation_chart_line(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn printer(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn puzzle(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
         <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn qrcode(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn question_mark_circle(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ReceiptRefund)]
pub fn receipt_refund(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ReceiptTax)]
pub fn receipt_tax(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn refresh(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn reply(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M7.707 3.293a1 1 0 010 1.414L5.414 7H11a7 7 0 017 7v2a1 1 0 11-2 0v-2a5 5 0 00-5-5H5.414l2.293 2.293a1 1 0 11-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" />
...
pub fn rewind(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn rss(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn save_as(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn save(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn scale(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn scissors(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(SearchCircle)]
pub fn search_circle(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn selector(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn share(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn shield_check(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ShieldExclamation)]
pub fn shield_exclamation(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn shopping_bag(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn shopping_cart(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(SortAscending)]
pub fn sort_ascending(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(SortDescending)]
pub fn sort_descending(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn sparkles(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn speaker_phone(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn star(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(StatusOffline)]
pub fn status_offline(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(StatusOnline)]
pub fn status_online(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn stop(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn sun(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn support(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(SwitchHorizontal)]
pub fn switch_horizontal(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(SwitchVertical)]
pub fn switch_vertical(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn table(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn template(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn thumb_down(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn thumb_up(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn ticket(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn translate(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn trash(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn trending_up(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn truck(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn upload(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn user_add(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(UserCircle)]
pub fn user_circle(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(UserGroup)]
pub fn user_group(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(UserRemove)]
pub fn user_remove(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn variable(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(VideoCamera)]
pub fn video_camera(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ViewBoards)]
pub fn view_boards(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ViewGridAdd)]
pub fn view_grid_add(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ViewGrid)]
pub fn view_grid(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn view_list(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn volume_off(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn volume_up(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn zoom_in(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn zoom_out(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd" />
...
pub fn cake(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn calculator(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn camera(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(Cash)]
pub fn cash(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ChartBar)]
pub fn chart_bar(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ChartPie)]
pub fn chart_pie(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ChartSquareBar)]
pub fn chart_square_bar(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ChatAlt2)]
pub fn chat_alt2(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn chat(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn check_circle(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ChevronDoubleDown)]
pub fn chevron_double_down(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
...
#[function_component(ChevronDoubleLeft)]
pub fn chevron_double_left(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
#[function_component(ChevronDoubleRight)]
pub fn chevron_double_right(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ChevronDoubleUp)]
pub fn chevron_double_up(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn cloud_upload(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn cloud_download(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn chip(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn clipboard_check(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn clipboard_copy(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn clipboard_list(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" />
...
pub fn cloud(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn cog(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn collection(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(ColorSwatch)]
pub fn color_swatch(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn credit_card(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(CubeTransparent)]
pub fn cube_transparent(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn cube(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(CurrencyBangladeshi)]
pub fn currency_bangladeshi(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(CurrencyDollar)]
pub fn currency_dollar(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(CurrencyEuro)]
pub fn currency_euro(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn currency_pound(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn currency_rupee(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn currency_yen(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(CursorClick)]
pub fn cursor_click(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(DesktopComputer)]
pub fn desktop_computer(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(DeviceMobile)]
pub fn device_mobile(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M3 5a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2h-2.22l.123.489.804.804A1 1 0 0113 18H7a1 1 0 01-.707-1.707l.804-.804L7.22 15H5a2 2 0 01-2-2V5zm5.771 7H5V5h10v7H8.771z" clip-rule="evenodd" />
...
#[function_component(DeviceTablet)]
pub fn device_tablet(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(DocumentAdd)]
pub fn document_add(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(DocumentDownload)]
pub fn document_download(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(DocumentDuplicate)]
pub fn document_duplicate(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(DocumentRemove)]
pub fn document_remove(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(DocumentReport)]
pub fn document_report(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(DocumentSearch)]
pub fn document_search(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(DocumentText)]
pub fn document_text(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn document(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(DotsCircleHorizontal)]
pub fn dots_circle_horizontal(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(DotsHorizontal)]
pub fn dots_horizontal(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(DotsVertical)]
pub fn dots_vertical(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(Duplicate)]
pub fn duplicate(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(EmojiHappy)]
pub fn emoji_happy(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(EmojiSad)]
pub fn emoji_sad(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn exclamation_circle(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(Exclamation)]
pub fn exclamation(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn external_link(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn fast_forward(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn film(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn filter(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn finger_print(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(Fire)]
pub fn fire(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn flag(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(FolderAdd)]
pub fn folder_add(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(FolderDownload)]
pub fn folder_download(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn folder_open(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(FolderRemove)]
pub fn folder_remove(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn gift(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(GlobeAlt)]
pub fn globe_alt(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn globe(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn hand(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn hashtag(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn heart(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(Identification)]
pub fn identification(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(InboxIn)]
pub fn inbox_in(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn inbox(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(InformationCircle)]
pub fn information_circle(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn library(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn light_bulb(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(LightningBolt)]
pub fn lightning_bolt(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn link(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(LocationMarker)]
pub fn location_marker(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(LockClosed)]
pub fn lock_closed(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn lock_open(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn login(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(MailOpen)]
pub fn mail_open(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn mail(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn map(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(MenuAlt1)]
pub fn menu_alt1(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(MenuAlt2)]
pub fn menu_alt2(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(MenuAlt3)]
pub fn menu_alt3(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(MenuAlt4)]
pub fn menu_alt4(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
#[function_component(Microphone)]
pub fn microphone(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn minus_circle(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(MinusSm)]
pub fn minus_sm(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn minus(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn moon(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn music_note(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn newspaper(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(OfficeBuilding)]
pub fn office_building(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(PaperAirplane)]
pub fn paper_airplane(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn paper_clip(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn pause(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(PencilAlt)]
pub fn pencil_alt(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn phone_incoming(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
#[function_component(PhoneMissedCall)]
pub fn phone_missed_call(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
...
pub fn phone_outgoing(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn phone(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
...
#[function_component(Photograph)]
pub fn photograph(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
pub fn play(props: &IconProps) -> Html {
    match &props.icon_type {
        IconType::Solid => html! {
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
